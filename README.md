...
Tiglon is an efficient genome-guided trascriptome assembler for RNA-seq data. It can assemble all transcripts with the help of different RNA-seq reads aligners(e.g. Hisat2, Star).
The software expects as input a file that lists alignment files generated by different aligners,and outputs all assembled candidate transcripts in gtf format. 
