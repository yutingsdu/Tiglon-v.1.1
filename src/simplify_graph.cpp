...
//return;
    ...
    */
    ...
    remove_partial_junction(delete_edges_child,delete_edges_parent); //LigerSimulation
    ...
    if(strand_specific == "unstranded") 
	    AVERAGE_REMOVE_RATE = 0.01; //for simulation star transref  //LigerSimulation
   ...
   //if(strand_specific != "unstranded" && !PackingFlag)  //LigerSimulation
   if(!PackingFlag)
...
//   remove_edges_onemulti(delete_edges_child,delete_edges_parent);
   ...
   //remove_small_exons(delete_edges_child,delete_edges_parent);
    ...
    {
     	//if(strand_specific != "unstranded") 
 	remove_small_exons(delete_edges_child,delete_edges_parent); //LigerSimulation
	//remove_edges_onemulti(delete_edges_child,delete_edges_parent);	
        delete_children_edges(delete_edges_child);
        delete_parents_edges(delete_edges_parent);
    }
